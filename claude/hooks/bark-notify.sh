#!/bin/bash
BARK_KEY="${BARK_DEVICE_KEY:?Set BARK_DEVICE_KEY in settings.local.json env}"
ENCRYPT_KEY="${BARK_ENCRYPT_KEY:?Set BARK_ENCRYPT_KEY in settings.local.json env}"
ENCRYPT_IV="${BARK_ENCRYPT_IV:?Set BARK_ENCRYPT_IV in settings.local.json env}"
